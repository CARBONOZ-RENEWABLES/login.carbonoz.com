...
const AdminMobileBottomNav: FC = (): ReactElement => {
  return (
    <nav
    ...
    >
      <div className='flex items-center justify-around h-16'>
        <NavItem icon={FileText} label='Redex' url='/admin/' />
        <NavItem icon={Activity} label='Logs' url='/admin/logs' />
        <NavItem icon={Users} label='Users' url='/admin/users' />
        <NavItem icon={CreditCard} label='Plans' url='/admin/plans' />
      </div>
    </nav>
  )
}
